...
<%
	...
	if(userName == null || "".equals(userName) 
		...
		response.sendRedirect("http://localhost:8080/springMVC/login.jsp?clientId="+clientId);
	}
...
<script type="text/javascript">
	function ajaxTest() {
		...
		$.ajax({
			type : "post",
			url : "http://localhost:8080/springMVC/oauth/token",
			dataType : "json",
			...
			success : function(data) {
				window.location.replace("http://localhost:8080/springMVC/index.html?"+data.access_token+"&"+data.refresh_token);
